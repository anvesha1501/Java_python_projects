// Database for staff.
// Super class called Staff with details as StaffId, Name, Phone, Salary.
// Inheritance is used to extend this super class to three subclasses namely Teaching (domain, publications), Technical (skills) and Contract (period). 
...
class Teaching extends staff_database
{
...
class Technical extends staff_database
{
...
class Contract extends staff_database
{
    private int period;
    public void accept()
    {
